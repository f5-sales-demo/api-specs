...
- **Correzioni dei vincoli** modificano i vincoli dello schema (allentano, restringono, aggiungono, rimuovono) in base al comportamento osservato dell'API. Consultare [Correzioni Applicate](03-fixes-applied/).
