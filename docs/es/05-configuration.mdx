...
Las pruebas en vivo resuelven sus dominios semánticos a partir de la salida de transformación corregida.
Los archivos sin procesar en `specs/original/` siguen siendo los bytes de entrada ascendentes inmutables y
nunca se presentan como el contrato de API intermedio corregido.
...
| `fix_strategies` | Asigna a cada tipo de discrepancia su acción de corrección. Consulte [Correcciones Aplicadas](/api-specs/en/03-fixes-applied/). |
