...
def test_schema_filename_validation_negative(valid_report_dict, invalid_filename):
    ...
    bad_report["summary"]["processed_specs"] = len(bad_report["summary"]["modified_files"]) + len(
        bad_report["summary"]["unmodified_files"]
    )
...
def test_schema_filename_validation_positive(valid_report_dict):
    ...
    for fname in valid_filenames:
        ...
        good_report["summary"]["processed_specs"] = len(
            good_report["summary"]["modified_files"]
        ) + len(good_report["summary"]["unmodified_files"])
