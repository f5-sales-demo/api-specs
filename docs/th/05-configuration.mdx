...
การทดสอบสดจะแก้ไขโดเมนความหมายจากผลลัพธ์การแปลงที่แก้ไขแล้ว
ไฟล์ดิบใน `specs/original/` ยังคงเป็นไบต์ขาเข้าต้นน้ำที่ไม่สามารถเปลี่ยนแปลงได้ และ
จะไม่ถูกนำเสนอเป็นสัญญา API ระดับกลางที่แก้ไขแล้ว
...
| `fix_strategies` | แมปประเภทความไม่สอดคล้องแต่ละประเภทกับการดำเนินการแก้ไข ดู [การแก้ไขที่ใช้](/api-specs/en/03-fixes-applied/) |
