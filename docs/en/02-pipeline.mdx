...
A parallel CI job generates `docs/en/01-validation-report.mdx` from the validation reports using `scripts/generate_docs.py`, then opens a PR if the content changed.
