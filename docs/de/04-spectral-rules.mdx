...
Diese Regeln werden vom Reconciler automatisch korrigiert, wenn Verstöße erkannt werden. Siehe [Angewandte Korrekturen](/api-specs/de/03-fixes-applied/) für Details zu jeder Korrektur.
