...
การแก้ไขเหล่านี้ปรับข้อจำกัดของ OpenAPI schema เพื่อให้สเปคตรงกับสิ่งที่ API จริงบังคับใช้ การแก้ไขแต่ละรายการขับเคลื่อนโดยอ็อบเจกต์ `Discrepancy` ที่สร้างขึ้นระหว่าง[การตรวจสอบ](/api-specs/en/02-pipeline/#2-validate)
...
การแก้ไขเหล่านี้แก้ไขปัญหาคุณภาพ OAS3 ที่พบโดย[การตรวจสอบ Spectral](/api-specs/en/04-spectral-rules/) เพิ่มหรือแก้ไขเมตาดาต้าโดยไม่เปลี่ยนพฤติกรรม API
...
URL ของเซิร์ฟเวอร์และค่าตัวแปรมาจาก `spectral.servers` ใน [validation.yaml](/api-specs/en/05-configuration/)
...
ค่ามาจาก `spectral.contact` ใน [validation.yaml](/api-specs/en/05-configuration/)
...
นิยามของ scheme มาจาก `spectral.security_scheme` ใน [validation.yaml](/api-specs/en/05-configuration/) สิ่งนี้บอกผู้ใช้ API ว่าจะตรวจสอบสิทธิ์อย่างไร แต่ไม่เปลี่ยนพฤติกรรมรันไทม์
