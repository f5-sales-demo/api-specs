...
I test dal vivo risolvono i loro domini semantici dall'output di trasformazione corretto.
I file grezzi in `specs/original/` rimangono i byte di destinazione upstream immutabili e
non vengono mai presentati come contratto API intermedio corretto.
...
| `fix_strategies` | Mappa ciascun tipo di discrepanza alla relativa azione correttiva. Vedere [Correzioni Applicate](/api-specs/en/03-fixes-applied/). |
