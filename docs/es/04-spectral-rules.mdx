...
description: >-
  Arquitectura Spectral de dos configuraciones con reglas OAS base y una función
...
El proyecto utiliza [Spectral](https://stoplight.io/open-source/spectral) para el linting de OAS3 con una arquitectura de dos configuraciones que separa las herramientas de CI/externas de la lógica personalizada del pipeline.
...
Estas reglas son corregidas automáticamente por el reconciliador cuando se detectan violaciones. Consulte [Correcciones Aplicadas](/api-specs/es/03-fixes-applied/) para obtener detalles sobre cada corrección.
