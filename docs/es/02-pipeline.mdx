...
- **Correcciones de restricciones** ajustan las restricciones del esquema (relajar, endurecer, agregar, eliminar) basándose en el comportamiento observado de la API. Consulte [Correcciones Aplicadas](03-fixes-applied/).
