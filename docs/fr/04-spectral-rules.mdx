...
Ces règles sont auto-corrigées par le réconcilieur lorsque des violations sont détectées. Voir [Corrections appliquées](03-fixes-applied/) pour les détails sur chaque correction.
