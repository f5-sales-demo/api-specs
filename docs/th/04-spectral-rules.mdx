...
กฎเหล่านี้จะถูกแก้ไขอัตโนมัติโดย reconciler เมื่อตรวจพบการละเมิด ดู [การแก้ไขที่ดำเนินการ](/api-specs/th/03-fixes-applied/) สำหรับรายละเอียดของแต่ละการแก้ไข
