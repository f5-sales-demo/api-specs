...
يتم إصلاح هذه القواعد تلقائياً بواسطة المُوفّق عند اكتشاف انتهاكات. راجع [الإصلاحات المُطبّقة](/api-specs/ar/03-fixes-applied/) لمزيد من التفاصيل حول كل إصلاح.
